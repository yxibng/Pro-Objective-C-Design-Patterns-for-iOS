...
@property (weak, nonatomic) IBOutlet UIView *canvasContainerView;
...
- (void) loadCanvasViewWithGenerator:(CanvasViewGenerator *)generator
{
    ...
    [self.canvasContainerView addSubview:aCanvasView];
    aCanvasView.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleHeight;
    aCanvasView.frame = self.canvasContainerView.bounds;
}
